...
** ut_isdigit.c
**
** Unit tests for isdigit function of Undefined-C library
**
...
int		ut_isdigit_validity(int N)
{
	...
	size_t		i;
	int			j;
	auto test_t	tdat[3] ={	{0x0, 0x2F, 0, 0},
							{0x30, 0x39, 0, 1},
							{0x3A, 0xFF, 0, 0}};
